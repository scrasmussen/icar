...
def main():
    ...
    opt.ICARoptions(nz = nz,
                    ...
                    zinfo_sleve = ".True.",
                    zinfo_terrain_smooth_windowsize = terrain_smooth_windowsize,
                    zinfo_terrain_smooth_cycles = terrain_smooth_cycles ,
                    zinfo_decay_rate_L_topo = decay_rate_L_topo,
                    zinfo_decay_rate_S_topo = decay_rate_S_topo,
                    zinfo_sleve_n = 1.35,
